package com.example.adsdentalsurgeryappointmentwebapi;

import com.example.adsdentalsurgeryappointmentwebapi.model.Role;
import com.example.adsdentalsurgeryappointmentwebapi.model.User;
import com.example.adsdentalsurgeryappointmentwebapi.repository.RoleRepository;
import com.example.adsdentalsurgeryappointmentwebapi.repository.UserRepository;
...
public class AdsDentalSurgeryAppointmentWebApiApplication {

    private UserRepository userRepository;
    private RoleRepository roleRepository;
    private PasswordEncoder passwordEncoder;

    public void AdsrestapiApplication(UserRepository userRepository,
    ...
    public static void main(String[] args) {
        SpringApplication.run(AdsDentalSurgeryAppointmentWebApiApplication.class, args);
    }
